...
import static com.my.company.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.my.company.PojaGenerated;
import com.my.company.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.my.company.event1";
    return "com.my.company.event2";
  }
}
